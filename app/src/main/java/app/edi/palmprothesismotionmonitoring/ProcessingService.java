...
public class ProcessingService {
    ...
    private long sessionSetLength = MainActivity.prescribedLength;       // how long session must run in [ms]
...
//                }
    ...
    public float getAcc1Z() {
        return sensors.get(0).getAccNormZ();
    }

    public float getAcc2X() {
        return sensors.get(1).getAccNormX();
    }

    public float getAcc2Y() {
        return sensors.get(1).getAccNormY();
    }
